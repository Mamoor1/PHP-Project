...
<?php
	...
	$query = "
		SELECT *
		FROM movielist where Rating like '%$data%'  order by ReleaseYear;
	";
 
	$Rating = mysqli_query($conn, $query);
...
<table width="900" border="1" align="center" cellpadding="5">
  <tr id="tableheader">
   ...
   <?php
			while($shop = mysqli_fetch_array($Rating)) {
...
<?php echo "<a href='Rating.php'>Go Back </a>"; ?>
