...
<?php
	...
	$query = "
		SELECT *
		FROM movielist where Duration like '%$data%'  order by ReleaseYear;
	";

	$Duration = mysqli_query($conn, $query);
?>
...
<table width="900" border="1" align="center" cellpadding="5">
  <tr id="tableheader">
   ...
   <?php
			while($shop = mysqli_fetch_array($Duration)) {
...
?>
<?php echo "<a href='Duration.php'>Go Back </a>"; ?>
